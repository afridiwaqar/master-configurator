...
def gen_config():
	...
	Config.add_section('')
	Config.set('', 'data_directory', "'/var/lib/postgresql/9.6/main'")
	Config.set('', 'hba_file', "'/etc/postgresql/9.6/main/pg_hba.conf'")
	Config.set('', 'ident_file', "'/var/run/postgresql/9.6-main.pid'")
	Config.set('', 'external_pid_file', "'/var/run/postgresql/9.6-main.pid'")
	...
	Config.set('', 'cluster_name', "'9.6/main'")
	Config.set('', 'track_counts', 'on')
	Config.set('', 'stats_temp_directory', "'/var/run/postgresql/9.6-main.pg_stat_tmp'")
